...
const dictionaries = {
  en: {
    ...
    auth: {
      ...
      loginTitle: "Bienvenido — back to the crew.",
      loginCta: "Log in",
    ...
    home: {
      ...
      heroTitle: "Rutas, fotos, groups, and a shared journal for the riders who keep showing up.",
      heroSummary:
    ...
    profile: {
      ...
      badgeMilesVeterano: "{miles} ridden · Veterano",
      ...
      sectionRoutesOwn: "Rutas you put on the board.",
      sectionRoutesOther: "Rutas {name} puts on the board.",
    ...
    routeBuilder: {
      ...
      gpsSnapping: "Snapping recorded GPS to nearby roads and trails...",
      gpsSnapFailed: "Street snapping was unavailable, so the raw GPS line will be saved.",
    ...
    rideScreen: {
      ...
      saveSuccessProvider: "Route saved with {provider} street matching. Open the ride screen to follow it live.",
      saveSuccessRide: "Route saved and your recorded ride was logged.",
      saveSuccessRideProvider: "Route saved with {provider} street matching and your recorded ride was logged.",
      saveUpdated: "Route updated.",
      saveUpdatedProvider: "Route updated with {provider} street matching.",
      metaStart: "Start",
      metaTerrain: "Terrain",
      metaNotes: "Notes"
    },
  ...
  es: {
    ...
    routeBuilder: {
      ...
      gpsSnapping: "Ajustando el GPS grabado a calles y senderos cercanos...",
      gpsSnapFailed: "El ajuste a calles no estuvo disponible, se guardará la línea GPS cruda.",
    ...
    rideScreen: {
      ...
      saveSuccessProvider: "Ruta guardada con coincidencia de calles vía {provider}. Abre la pantalla de ride para seguirla en vivo.",
      saveSuccessRide: "Ruta guardada y se registró tu ride.",
      saveSuccessRideProvider: "Ruta guardada con coincidencia de calles vía {provider} y se registró tu ride.",
      saveUpdated: "Ruta actualizada.",
      saveUpdatedProvider: "Ruta actualizada con coincidencia de calles vía {provider}.",
      metaStart: "Inicio",
      metaTerrain: "Terreno",
      metaNotes: "Notas"
    },
